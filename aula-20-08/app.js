...
function classificaImc() {
    ...
    const tag_img = document.getElementById('imgResultado');

    if (resultado <= 18.5) {
        tag_img.src = 'imgs-imc/magreza.png';

    } else if (resultado > 18.6 &&  resultado < 24.9) {
        tag_img.src = 'imgs-imc/normal.png';
    } else if (resultado > 25.0 && resultado < 29.9){
        tag_img.src = 'imgs-imc/sobrepeso.png';
    } else if (resultado > 30.0 && resultado < 34.9){
        tag_img.src = 'imgs-imc/grau1.png';
    }else if (resultado > 35.0 && resultado < 39.9){
        tag_img.src = 'imgs-imc/grau2.png';
    }else if (resultado > 40.0){
        tag_img.src = 'imgs-imc/grau3.png'
    }
}